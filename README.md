...
Microservice for Quality Assurance in [freeCodeCamp](https://www.freecodecamp.org/learn/).

[Live Website](https://metric-imperial-converter-chiefwoods.replit.app/)

[Source Repository](https://github.com/ChiefWoods/metric-imperial-converter)
...
```
git clone https://github.com/ChiefWoods/metric-imperial-converter.git
```
...
View the [open issues](https://github.com/ChiefWoods/metric-imperial-converter/issues) for a full list of proposed features and known bugs.
